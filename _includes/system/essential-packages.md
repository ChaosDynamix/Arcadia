...
##### Example
```
$ pacstrap /mnt base linux linux-firmware{% if scenario.pacstrap.has_needed_packages %} {{ scenario.pacstrap.needed_packages }}{% endif %} sudo vim man-db man-pages networkmanager linux-headers broadcom-wl-dkms
```
